        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BrokerageOpints = table.Column<int>(nullable: false),
                    ...
                    Incom = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectsVisibleRules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectsVisibleRules_Projects_ProjectId",
                        column: x => x.ProjectId,
                        principalTable: "Projects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectsVisibleRules_ProjectId",
                table: "ProjectsVisibleRules",
                column: "ProjectId",
                unique: true);
